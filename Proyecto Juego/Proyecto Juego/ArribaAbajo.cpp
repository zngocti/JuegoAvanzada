...
sf::Time ArribaAbajo::cdAtaque = sf::seconds(6.5f);
...
void ArribaAbajo::activarReciclar()
{
	reciclar = true;
}

void ArribaAbajo::setData(int num, bool enemigo)
{

}

bool ArribaAbajo::getEsEnemigo() const
{
	return false;
}
